...
### [](https://github.com/vicreative/React-Native-Paystack-WebView#installation)Installation

Add React-Native-Paystack-WebView to your project by running;

`npm install vicreative-react-native-paystack-webview`

or

`yarn add vicreative-react-native-paystack-webview`
...
### [](https://github.com/vicreative/React-Native-Paystack-WebView#usage)Usage 1

```javascript
import React from 'react';
import { Paystack } from 'vicreative-react-native-paystack-webview';
